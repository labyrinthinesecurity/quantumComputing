...
#    norm=np.dot(np.conj(psi_t), psi_t)
    sigma=linalg.norm(psi_t[0])+linalg.norm(psi_t[1])+linalg.norm(psi_t[2])+linalg.norm(psi_t[3])+linalg.norm(psi_t[4])+linalg.norm(psi_t[5])+linalg.norm(psi_t[6])+linalg.norm(psi_t[7])
    print(st,linalg.norm(psi_t[0])/sigma,linalg.norm(psi_t[1])/sigma,linalg.norm(psi_t[2])/sigma,linalg.norm(psi_t[3])/sigma,linalg.norm(psi_t[4])/sigma,linalg.norm(psi_t[5])/sigma,linalg.norm(psi_t[6])/sigma,linalg.norm(psi_t[7])/sigma)#,normalization)#,normalization)
